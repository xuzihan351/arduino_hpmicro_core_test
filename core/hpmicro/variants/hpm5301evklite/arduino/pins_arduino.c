...
const hpm_pin_info_t PIN_MAP[BOARD_NR_GPIO_PINS] = {
    ...
    [PIN_J3_3] = { .gpio_device = &pin_p1_3_info, .pwm_device = NULL, .adc_device = &board_adc_infos[0], },
    [PIN_J3_5] = { .gpio_device = &pin_p1_5_info, .pwm_device = NULL, .adc_device = &board_adc_infos[1], },
    [PIN_J3_7] = { .gpio_device = &pin_p1_7_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_8] = { .gpio_device = &pin_p1_8_info, .pwm_device = NULL, .adc_device = &board_adc_infos[7], },
    [PIN_J3_10] = { .gpio_device = &pin_p1_10_info, .pwm_device = NULL, .adc_device = &board_adc_infos[6], },
    [PIN_J3_11] = { .gpio_device = &pin_p1_11_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_13] = { .gpio_device = &pin_p1_13_info, .pwm_device = NULL, .adc_device = &board_adc_infos[3], },
    [PIN_J3_19] = { .gpio_device = &pin_p1_19_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_21] = { .gpio_device = &pin_p1_21_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_23] = { .gpio_device = &pin_p1_23_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_24] = { .gpio_device = &pin_p1_24_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_26] = { .gpio_device = &pin_p1_26_info, .pwm_device = NULL, .adc_device = &board_adc_infos[2], },
    [PIN_J3_27] = { .gpio_device = &pin_p1_27_info, .pwm_device = NULL, .adc_device = &board_adc_infos[4], },
    [PIN_J3_28] = { .gpio_device = &pin_p1_28_info, .pwm_device = &pwm_info[1], .adc_device = &board_adc_infos[5], },
    [PIN_J3_29] = { .gpio_device = &pin_p1_29_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_31] = { .gpio_device = &pin_p1_31_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_32] = { .gpio_device = &pin_p1_32_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_33] = { .gpio_device = &pin_p1_33_info, .pwm_device = &pwm_info[0], .adc_device = NULL, },
    [PIN_J3_36] = { .gpio_device = NULL, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_37] = { .gpio_device = &pin_p1_37_info, .pwm_device = NULL, .adc_device = NULL, },
    [PIN_J3_38] = { .gpio_device = &pin_p1_38_info, .pwm_device = NULL, .adc_device = NULL, },
};
